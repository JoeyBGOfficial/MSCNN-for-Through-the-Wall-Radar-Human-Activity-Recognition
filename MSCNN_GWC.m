...
trainingSetup = load("D:\MatlabR2022a\bin\JoeyBG_Sundries\Multi-Sampling_Class\MSCNN_Parameters.mat");
...
tempLayers = [
    maxPooling2dLayer([5 5],"Name","maxpool_3","Padding","same","Stride",[4 4])
    convolution2dLayer([7 7],8,"Name","conv_3")
    maxPooling2dLayer([5 5],"Name","maxpool_6","Stride",[2 2])
...
lgraph = connectLayers(lgraph,"datainput","maxpool_3");
...
f = gcf;
exportgraphics(f,'Confusion Matrix MSCNN.png','Resolution',600);