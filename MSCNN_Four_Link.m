...
trainingSetup = load("D:\MatlabR2022a\bin\JoeyBG_Sundries\Multi-Sampling_Class\MSCNN_Four_Link_Parameters.mat");
...
tempLayers = [
    ...
    convolution2dLayer([7 7],8,"Name","conv_3","Bias",trainingSetup.conv_3.Bias,"Weights",trainingSetup.conv_3.Weights)
    maxPooling2dLayer([5 5],"Name","maxpool_6_1","Stride",[2 2])
    convolution2dLayer([5 5],16,"Name","conv_6","Bias",trainingSetup.conv_6.Bias,"Weights",trainingSetup.conv_6.Weights)
...
tempLayers = [
    ...
    convolution2dLayer([9 9],32,"Name","conv","Bias",trainingSetup.conv.Bias,"Weights",trainingSetup.conv.Weights)
...
lgraph = connectLayers(lgraph,"maxpool_9","depthcat/in3");
lgraph = connectLayers(lgraph,"maxpool_10","depthcat/in4");
lgraph = connectLayers(lgraph,"maxpool_12","depthcat/in2");
lgraph = connectLayers(lgraph,"maxpool_6_2","depthcat/in1");
...
f = gcf;
exportgraphics(f,'Confusion Matrix MSCNN Four Link.png','Resolution',600);